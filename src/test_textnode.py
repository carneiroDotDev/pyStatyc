...
class TestTextNode(unittest.TestCase):
    ...
    def test_unequal(self):
        node = TextNode("This is a text node", TextType.BOLD)
        node2 = TextNode("This is a different text node", TextType.ITALICS)
        self.assertNotEqual(node, node2)
        
    def test_repr(self):
        node = TextNode("This is a text node", TextType.BOLD)
        expected_repr = "TextNode(This is a text node, TextType.BOLD, None)"
    ...
    def test_invalid_text_type_enum(self):
        with self.assertRaises(ValueError):
            TextNode("This is a text node", TextType("invalid_text_type"))
